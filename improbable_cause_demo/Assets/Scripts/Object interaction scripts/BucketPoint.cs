...
public class BucketPoint : AnchorPoint {
    ...
    {
        if (collision.gameObject.GetComponent<JumperComponent>() && IsOccupied != true)
        {
   ...
   public void changeAngle()
    ...
    void grabObject(GameObject obj)
    {
        ...
        setObject();
        JumperComponent JumperComponent = obj.GetComponent<JumperComponent>();
        if(JumperComponent != null)
        {
            JumperComponent.StartCatapult();
            changeAngle();
        }
    }
}
